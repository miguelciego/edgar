...
public class HoraFichaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hora_ficha);
        adpt = new SimpleAdapter(this, new ArrayList<Ninjas>());

        ListView ls1 = (ListView) findViewById(R.id.listView4);
        assert ls1 != null;
        ls1.setAdapter(adpt);

        (new AsyncListViewLoader()).execute("http://190.129.209.142:61183/mig/e_hora.php");
        ...
        ls1.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?>arg0, View arg1, int arg2, long arg3){
                ...
                Intent ir = new Intent(getApplicationContext(), TerceraActivity.class);
                startActivity(ir);
            }
    ...
    public class AsyncListViewLoader extends AsyncTask<String, Void, List<Ninjas>> {
        ...
        private final ProgressDialog dialog = new ProgressDialog(HoraFichaActivity.this);
        ...
        protected List<Ninjas> doInBackground(String... params) {
            ...
            try
            {
                ...
                String resultJSON = respuestaJSON.getString("Horario");
